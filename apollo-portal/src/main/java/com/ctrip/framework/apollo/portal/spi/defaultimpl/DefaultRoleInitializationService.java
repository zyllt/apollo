...
public class DefaultRoleInitializationService implements RoleInitializationService {
    ...
    private void createAppMasterRole(final String appId, final String operator) {
        Set<Permission> appPermissions =
                FluentIterable.from(Lists.newArrayList(
                        ...
                        .transform(new Function<String, Permission>() {
                            @Override
                            public Permission apply(String permissionType) {
                                return createPermission(appId, permissionType, operator);
                            }
                        }).toSet();
        ...
        Set<Long>
                appPermissionIds =
                FluentIterable.from(createdAppPermissions)
                        .transform(new Function<Permission, Long>() {
                            @Override
