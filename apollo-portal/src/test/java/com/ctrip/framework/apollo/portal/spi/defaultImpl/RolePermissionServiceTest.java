...
//            .transform(
//                    new Function<RolePermission, Long>() {
//                      @Override
//                      public Long apply(RolePermission rolePermission) {
...
//
//    Set<String> userIds = FluentIterable.from(users).transform(
