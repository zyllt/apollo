...
public class ConfigController {
    ...
    private static final Joiner CLUSTER_NAMESPACE_SEPARATOR_JOINER = Joiner.on(ConfigConsts.CLUSTER_NAMESPACE_SEPARATOR);
    ...
    public ApolloConfig queryConfig(@PathVariable String appId, @PathVariable String clusterName,
        ...
        String mergedReleaseKey =
                ...
                }).join(CLUSTER_NAMESPACE_SEPARATOR_JOINER);

//            releases.stream().map(Release::getReleaseKey)
//            .collect(Collectors.joining(ConfigConsts.CLUSTER_NAMESPACE_SEPARATOR));
    ...
    private Release findPublicConfig(String clientAppId, String clientIp, String clusterName,
        ...
        if (appNamespace == null || Objects.equals(clientAppId, appNamespace.getAppId())) {
            return null;
        }
    ...
    Map<String, String> mergeReleaseConfigurations(List<Release> releases) {
        ...
        for (Release release : Lists.reverse(releases)) {
            result.putAll((Map<? extends String, ? extends String>) gson.fromJson(release.getConfigurations(), configurationTypeReference));
        }
        return result;
    }
    ...
    private String assembleKey(String appId, String cluster, String namespace, String dataCenter) {
       ...
       return CLUSTER_NAMESPACE_SEPARATOR_JOINER.join(keyParts);
